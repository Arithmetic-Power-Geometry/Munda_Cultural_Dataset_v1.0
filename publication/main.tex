...
The current source census is incomplete in the ordinary empirical sense and is never presented as future-proof or metaphysically complete. Mundarica Volume I has structural page accounting but lacks a registered authoritative scan; Volumes II and III have externally verified locators but no locally registered authoritative scan artifacts; Volumes IV--XVI remain discovery/acquisition work. Consequently, \MLHKPMundaricaVerified{} volumes are VERIFIED COMPLETE in this snapshot. Community validation, reuse permission and present-day universality must be established independently for records that require them. The \MLHKPDomainHomes{} explicit domain homes indicate schema representation only; they must not be interpreted as evidence coverage or cultural completeness.
