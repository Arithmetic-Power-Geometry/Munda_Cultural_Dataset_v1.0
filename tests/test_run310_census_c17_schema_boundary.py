...
def test_run310_c17_exact_locator_boundary():
    path = Path("data/source_census/census_c17_jharkhand_exact_schema_locator_run310_2026-09-13.json")
    ...
    assert required <= set(obj["exact_schema_locators"])
