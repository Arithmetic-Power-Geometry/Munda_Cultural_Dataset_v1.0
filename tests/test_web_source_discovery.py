...
def test_web_discovery_records_have_unique_ids_and_urls():
    ...
    assert ids == [f'WEB-MUN-{i:04d}' for i in range(1, 15)]
...
def test_government_and_bibliographic_records_preserve_rights_boundaries():
    ...
    for source_id in ['WEB-MUN-0008', 'WEB-MUN-0009', 'WEB-MUN-0010', 'WEB-MUN-0011', 'WEB-MUN-0012', 'WEB-MUN-0014']:
        note = records[source_id]['rights_note'].lower()
        assert any(term in note for term in ['terms', 'does not', 'rights', 'reuse'])
